...
def parttimefromrekorder(na, quarter_duration = 4):
    eight_frames = list()
    for k in range(8):
        eight_frames.append(na["pitch"][np.logical_and(na["onset_sec"] < (k+1)*1.25, na["onset_sec"] >= k*1.25)])
    time_per_div = 1.25 / quarter_duration
